    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="container">
            <div class="form-horizontal"><br /><br />
                <h3>Want to Recover Your Password ?</h3>
                <hr />
                <h4>Please enter your valid email address,we will send instructions on how to reset your password.</h4>
                ...
                <div class="form-group">
                    <div class="col-md-2"></div>
                     <div class="col-md-6">
                    <asp:Button ID="PassReset" runat="server" CssClass="btn btn-default" Text="Submitt" OnClick="PassReset_Click" />
                    <asp:Label ID="LblPassReset" runat="server" ></asp:Label></div>
                </div>
            </div>
        </div>
